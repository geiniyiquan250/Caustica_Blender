...
#undef FILM_CONVERT_KERNEL_AS_STRING
    ...
    case DEVICE_KERNEL_FILM_PHOTON_SMOOTH:
      return "film_photon_smooth";
    case DEVICE_KERNEL_PHOTON_TRACE:
      return "photon_trace";
    case DEVICE_KERNEL_PHOTON_BIN_COUNT:
      return "photon_bin_count";
    case DEVICE_KERNEL_PHOTON_BIN_CURSOR_INIT:
