...
DeviceScene::DeviceScene(Device *device)
    : bvh_nodes(device, "bvh_nodes", MEM_GLOBAL),
      ...
      photon_beam_sigma(device, "photon_beam_sigma", MEM_GLOBAL),
      photon_cell_start(device, "photon_cell_start", MEM_GLOBAL),
      photon_shader_caster(device, "photon_shader_caster", MEM_GLOBAL),
      photon_volume_beam_start(device, "photon_volume_beam_start", MEM_GLOBAL),
      photon_volume_beam_end(device, "photon_volume_beam_end", MEM_GLOBAL),
