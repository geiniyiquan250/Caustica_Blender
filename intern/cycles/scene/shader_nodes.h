...
class ImageTextureNode : public ImageSlotTextureNode {
 public:
   ...
   * caustics, the other does. It used to read the file with OIIO, which
   * fails for the packed images that most real scenes ship with: no path,
