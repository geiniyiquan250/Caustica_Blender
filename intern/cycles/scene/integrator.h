...
class Integrator : public Node {
 public:
   ...
   * (default off = every physically plausible material casts). */
  NODE_SOCKET_API(bool, photon_casters_selected)
  /* CyclesPlus: artistic multiplier on the caustic contribution (1 = the
